define(["require", "exports"], function (require, exports) {
    ...
    //readme  url:https://github.com/foolishchow/element-tree-grid
    ...
    var descendantsIds = function descendantsIds(id, data, parentKey, treeKey) {
        var result = [], compare = [id], length = -1;
    ...
    var toggleExpanded = function toggleExpanded(context, scope, isExpended) {
        var treeKey = context.props.treeKey, states = scope.store.states;
    ...
    var getIndex = function getIndex(context, scope, data) {
        var index = -1, treeKey = context.props.treeKey;
    ...
    var Colspand = function Colspand(context, scope, data) {
        var _a = context.props, parentKey = _a.parentKey, treeKey = _a.treeKey, states = scope.store.states, row = scope.row;
    ...
    var insertRows = function insertRows(context, scope, children, updateChild) {
        if (updateChild === void 0) { updateChild = false; }
        ...
        if (updateChild)
            prefix[_index][context.props.childKey] = children;
        _data = prefix.concat(children).concat(_data);
        return _data;
    };
    var ExpandRemote = function ExpandRemote(context, scope, data) {
        var _a = context.props, treeKey = _a.treeKey, remote = _a.remote;
    ...
    function doExpand(context, scope) {
        var data = clone(scope.store.states._data), childKey = context.props.childKey;
        // line is loading
        if (isLoadingRow(context, scope))
            return;
        ...
        var _a = context.props, remote = _a.remote, allRemote = _a.allRemote;
        if (remote && allRemote) {
    ...
    var RenderFolder = function RenderFolder(h, context, scope) {
        ...
        }, [h('span', { style: { paddingLeft: paddingLeft(context, scope) } }, [h('i', { 'class': icon(scope, context) }), h('i', { 'class': folderIcon(context, scope) })]), renderDetail(h, context, scope)]);
    };
    var RenderLeaf = function RenderLeaf(h, context, scope) {
        return h('span', { style: { paddingLeft: paddingLeft(context, scope) } }, [h('i', { 'class': context.props.fileIcon }), renderDetail(h, context, scope)]);
    };
    ...
    var ElTableTreeColumn = {
        ...
        render: function render(h, context) {
            ...
            return h('el-table-column', index([attrs, {
                    scopedSlots: {
    ...
    exports.default = ElTableTreeColumn;
});
//# sourceMappingURL=TableTreeColumn.js.map